 ...
 * @author vinhb
 */
public class ChoiVoiNguoi extends javax.swing.JFrame{
    ...
    public ChoiVoiNguoi(User competitor, int room_ID, int isStart, String competitorIP) {
        initComponents();
        ...
        FormOcaro.setLayout(new GridLayout(size, size));
        //Setup play button
    ...
    private void initComponents() {
        ...
        FormOcaro = new javax.swing.JPanel();
        ...
        jLabel2.setText("Game Win");

        yourTurnJLabel3.setForeground(new java.awt.Color(255, 0, 0));
        yourTurnJLabel3.setText("Đến lượt bạn");

        jLabel8.setText("InGame");

        jLabel4.setText("Game Play");

        jLabel9.setText("Game Win");

        jLabel10.setText("InGame");

        jLabel11.setText("Game Play");
        ...
        FormOcaro.setBackground(new java.awt.Color(0, 255, 204));
        FormOcaro.setBorder(new javax.swing.border.MatteBorder(null));

        javax.swing.GroupLayout FormOcaroLayout = new javax.swing.GroupLayout(FormOcaro);
        FormOcaro.setLayout(FormOcaroLayout);
        FormOcaroLayout.setHorizontalGroup(
            FormOcaroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 833, Short.MAX_VALUE)
        );
        FormOcaroLayout.setVerticalGroup(
            FormOcaroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(FormOcaro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(29, 29, 29)
                                .addComponent(timerjLabel19, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(14, 14, 14)
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        JOptionPane.showMessageDialog(rootPane, "Thông báo", ":D", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void playSound() {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("assets/sound/click2.wav").getAbsoluteFile());
    ...
    public void playSound1() {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("assets/sound/1click2.wav").getAbsoluteFile());
            Clip clip = AudioSystem.getClip();
            clip.open(audioInputStream);
            clip.start();
        } catch (Exception ex) {
    ...
    public void playSound2() {
        try {
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("assets/sound/win2.wav").getAbsoluteFile());
            Clip clip = AudioSystem.getClip();
            clip.open(audioInputStream);
            clip.start();
        } catch (Exception ex) {
    ...
    public void increaseWinMatchToUser(){
        ...
        tmp += "--Chúc mừng bạn là người chiến thắng ,tỉ số là"+userWin+"-"+competitorWin+"--\n";
    ...
    public void increaseWinMatchToCompetitor(){
        ...
        jLabel20.setText("Tỉ số: "+userWin+"-"+competitorWin);
        String tmp = jTextArea1.getText();
        tmp += "--Bạn thua rồi cố gắn lên, tỉ số hiện tại là "+userWin+"-"+competitorWin+"--\n";
        jTextArea1.setText(tmp);
        jTextArea1.setCaretPosition(jTextArea1.getDocument().getLength());
    }
    ...
    private javax.swing.JPanel FormOcaro;
